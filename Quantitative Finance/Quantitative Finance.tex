...
\newpage
    ...
    \begin{itemize}
        ...
        \item How to do option Replication: \\
            1. get option return $\longrightarrow$ payoff that we want to reeplicate \\
            2. use stock price to match option payoff $\longrightarrow$ volatility match\\
                (formula Option2, page8)\\
            3. match bond with the difference of value between stock and option $\longrightarrow$ principle match\\
                (formula Option2, page8) the diff between payoff\\
        \item The practical side of arbitrage - restrictions:\\
            1. bid-ask spread\\
            2. lending fee for short stock\\
            3. lending fee for rf asset\\
        \item {\color{red}Formula - option pricing with arbitrage}\\
            1. (formula Option2, page17)\\
            2. (formula Option2, page18)\\
            3. (formula Option2, page8)\\
